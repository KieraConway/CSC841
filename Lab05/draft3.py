...
def parse_frame(frame):
    ...
    if frame.haslayer(Dot11Beacon):
        ...
        frame_data = """
            ...
            "_status_code": "%s"
        """ % (frame_type, channel, essid, dst_adr, src_adr, bssid,
               time_epoch, time_format, sig_str, auth_algo_num, status )
        ...
        if frame.haslayer(Dot11AssocReq):  # Association Request Frames
            ...
            frame_data = """
                 ...
                 "_listen_interval": "%s"
             """ % (frame_type, channel, essid, dst_adr, src_adr, bssid,
                    time_epoch, time_format, sig_str, cap_info, listen_int)
...
def send_gelf():
    ...
    {
        "version": "1.1",
        "host": "8745df80/server",
        "short_message": "WiFi frame analysis for beacons, auth and assoc",
        "_frames": %s
